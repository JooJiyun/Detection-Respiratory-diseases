...
#class_range = [[0]*3, [1]*5, [2]*20, [3]*1, [4]*1, [5]*3, [6]*5, [7]*2]
class_range = [[0]*3, [1]*5, [2]*1, [3]*1, [4]*3, [5]*5, [6]*2] # not COPD
class_range = sum(class_range, [])
...
class DataManager():
    ...
    def load_data(self):
        ...
        for i in range(self.batch_size):
            diag_idx = random.randrange(0,20)
            diag_idx = class_range[diag_idx]
...
class CRNN():
    ...
    def crnn(self, batch_size):
        ...
        decay_steps = 700
        lr_decayed = tf.train.cosine_decay(lr, global_step, decay_steps)
...
crnn = CRNN(32,'./log/save_notCOPD_cos/',False)
crnn.train(3000)