...
class DataManager():
    ...
    def train_data(self):
        ...
        for i in range(self.batch_size):
            ...
            data_arr = csv_file.loc[index, 'stft']
    ...
    def model(self, batch_size):
        ...
        def CNN(inputs):
            ...
            with tf.variable_scope(None, default_name = 'CNN'):
                ...
                inputs = build_resnet_block(inputs, 128, 512, False, "identity3", k_size = 5,  reduce = True)
        ...
        logits = tf.reshape(RNN_outputs, [batch_size, 40*512])
        print('*** rnn reshape ',RNN_outputs.shape,' ***')

        W1 = tf.Variable(tf.truncated_normal([40*512, 512], stddev=0.1), name="W1")
